...
class ProfileServiceProxy:
    ...
    def from_client(cls, client: Client) -> ProfileServiceProxy:
        return ServiceProxy.from_client(client, cls.SERVICE_CLASS.UUID)
...
class Client:
    ...
    pending_response: asyncio.futures.Future[ATT_PDU] | None
    pending_request: ATT_PDU | None
    ...
    async def write_value(
        self, attribute: int | AttributeProxy, value: bytes, with_response: bool = False
    ) -> None:
        '''
