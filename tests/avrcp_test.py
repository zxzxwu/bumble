...
@pytest.mark.parametrize(
    ...
    [
        ...
        avrcp.SetAddressedCommand(player_id=1),
        avrcp.SetBrowsedCommand(player_id=1),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        avrcp.SetAddressedResponse(status=avrcp.StatusCode.OPERATION_COMPLETED),
        avrcp.SetBrowsedResponse(
