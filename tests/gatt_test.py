...
def test_permissions_from_string():
    assert Attribute.Permission.from_string('READABLE') == 1
    assert Attribute.Permission.from_string('WRITEABLE') == 2
    assert Attribute.Permission.from_string('READABLE,WRITEABLE') == 3
